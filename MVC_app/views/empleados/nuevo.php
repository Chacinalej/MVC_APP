...
<body>
    <div class="container py-5">
        <h1 class="text-center mb-5">Insertar Empleado</h1>
        <form action="/MVC_APP/public/Empleado/guardar" method="POST">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="idm" class="form-control" placeholder=" " value="">
                <label for="idm">ID Manager:</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="salary" class="form-control" placeholder=" " value="">
